...
class videoCommentChk_selectChkStatusWaitCommentPage(unittest.TestCase):
    """查询评论待审核分页列表"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        ...
        backHttp.selectChkStatusWaitCommentPage(data,self.token)
    ...
    def b(self):
        ...
        backHttp.selectChkStatusWaitCommentPage(data)
