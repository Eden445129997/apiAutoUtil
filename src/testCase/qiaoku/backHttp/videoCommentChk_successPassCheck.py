...
class videoCommentChk_successPassCheck(unittest.TestCase):
    """评论审核-通过审核"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        ...
        backHttp.videoCommentChk_successPassCheck(data,self.token)
    ...
    def b(self):
        ...
        backHttp.videoCommentChk_successPassCheck(data)
