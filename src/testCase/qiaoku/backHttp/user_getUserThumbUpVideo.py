...
class user_getUserThumbUpVideo(unittest.TestCase):
    """获取用户点赞的视频信息"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        """获取用户点赞的视频信息"""
        data = {
            "userId":"618815311222669312",
            # "pageIndex":0,
            # "pageSize":10,
        }
        backHttp.getUserThumbUpVideo(data,self.token)
    ...
    def b(self):
        ...
        backHttp.getUserThumbUpVideo(data)
