...
class userModifyRecord_selectUserModifyRecordChkStatusWaitPage(unittest.TestCase):
    """查询用户审核待审核分页列表"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        """查询用户审核待审核分页列表"""
        data = {
            # "startApplyDate":"2019-01-08T16:00:00.000Z",
            # "endApplyDate":"2019-16-08T16:00:00.000Z",
            "applyType":2,
        }
        backHttp.selectUserModifyRecordChkStatusWaitPage(data,self.token)
    ...
    def b(self):
        ...
        backHttp.selectUserModifyRecordChkStatusWaitPage(data)
