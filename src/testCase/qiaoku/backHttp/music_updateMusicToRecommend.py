...
class music_updateMusicToRecommend(unittest.TestCase):
    """编辑音乐"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        data = {
            "musicId":"14",
            # "coverPhoto":"https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3276179142,1686381254&fm=26&gp=0.jpg",
            # "musicName":"123",
            # "singer":"李荣浩",
            "isDisplay":"1",
        }
        backHttp.updateMusicByConditionBack(data)
