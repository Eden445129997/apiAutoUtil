...
class userModifyRecord_successPassCheck(unittest.TestCase):
    """用户信息审核通过接口"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        ...
        backHttp.userModifyRecord_successPassCheck(data,self.token)
    ...
    def b(self):
        ...
        backHttp.userModifyRecord_successPassCheck(data)
