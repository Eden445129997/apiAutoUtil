...
class category_query(unittest.TestCase):
    """查询视频分类分页列表"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        ...
        data = {
            "keywords":"酷车车",
            "beginTime":"2019-01-08T16:00:00.000Z",
            "endTime":"2019-09-18T16:00:00.000Z",
        }
        backHttp.category_query(data,self.token)

    def b(self):
        """不带token"""
        data = {
            "keywords":"河",
            # "beginTime":"2019-09-08T16:00:00.000Z",
            # "endTime":"2019-09-08T16:00:00.000Z",
        }
        backHttp.category_query(data)
