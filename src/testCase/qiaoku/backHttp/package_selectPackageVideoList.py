...
class package_selectPackageVideoList(unittest.TestCase):
    """查询视频包视频列表-不分页"""
    #初始化
    def setUp(self):
        # 初始化（清理数据库所有的表）
    ...
    def a(self):
        ...
        data = {
            "packageId":21,
            # "keywords":"我推我的车，你坐你的车",
            # "categoryId":16,
            "startTime":"2019-01-18T16:00:00.000Z",
            "endTime":"2019-09-18T16:00:00.000Z",
        }
        backHttp.selectPackageVideoList(data,self.token)
    ...
    def b(self):
        ...
        data = {
            "packageId":21,
            "keywords":"就决定是你了",
            # "categoryId":"2019-09-18T16:00:00.000Z",
            # "startTime":"2019-09-18T16:00:00.000Z",
            # "endTime":"2019-09-18T16:00:00.000Z",
        }
        backHttp.selectPackageVideoList(data)
